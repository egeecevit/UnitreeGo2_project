...
int main( int argc, char **argv) {
  ...
  // Add the MdlDrawTriangle module
  MdlDrawTriangle *drawTriangle = new MdlDrawTriangle();
  mm.addModule(drawTriangle, 1, 0, USER_CONTROLLERS);
  ...
  // Clean up the MdlDrawTriangle module
  mm.removeModule( drawTriangle );
  delete drawTriangle;
